...
- product_list     → "which/what products does [supplier] have for [client]?" — use ONLY when asking about a specific supplier's products
- product_details  → use for ALL other product questions including:
                     "products from [country]", "rate details with [supplier]",
                     "routes covered by [supplier]", "inbound/outbound products",
                     "show me [client]'s products", "what rates does [client] have"
